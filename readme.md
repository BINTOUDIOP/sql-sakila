...
###  Partie 1 : Analyse de données (Base Sakila)
Utilisation d'une base de données relationnelle simulant un système de location de DVD.
* **Requêtes avancées :** Jointures multiples, agrégations complexes et calculs de KPIs.
...
* **Intégrité :** Gestion des clés étrangères (Foreign Keys) et contraintes d'intégrité lors de l'insertion de données multi-tables.

###  Compétences démontrées
* SQL (MySQL/DBeaver)
* Business Analytics et Reporting